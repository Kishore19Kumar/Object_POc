...
const s3bucket_bucketOperation s3bucket_bucketOperation_bucketOperation_MAX = s3bucket_bucketOperation_LIST_OBJECT_VERSIONS;
...
const s3object_objectOperation s3object_objectOperation_objectOperation_MAX = s3object_objectOperation_LIST_MULTIPART_OBJECT;
...
const serviceRequestResponse_serviceEntity serviceRequestResponse_serviceEntity_serviceEntity_MAX = serviceRequestResponse_serviceEntity_ACCESSKEY;
